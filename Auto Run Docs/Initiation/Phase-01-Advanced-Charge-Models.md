...
- [x] Run full test suite with coverage and lint one final time:
  ...
  - **Note:** Final verification complete. `ruff format` — 76 files unchanged. `ruff check` — all checks passed. `pytest` — 545 tests passed, 100.00% coverage achieved. All charge models verified working end-to-end.
