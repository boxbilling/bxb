...
- [ ] Activity feed: add "View all" link to Audit Logs, add filters
- [ ] Add revenue breakdown by plan (pie/donut chart)
- [ ] Sparkline charts inside stat cards for mini-trends
...
- [ ] Display metadata as key-value pills instead of raw JSON
...
- [ ] Show expression/field_name in a code-formatted block on card
