...
async def enqueue_check_usage_alerts(subscription_id: str) -> Job:
    """Enqueue a task to check usage alerts for a subscription."""
    return await enqueue_task("check_usage_alerts_task", subscription_id)
