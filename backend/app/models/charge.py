...
class Charge(Base):
    ...
    plan_id = Column(UUIDType, ForeignKey("plans.id", ondelete="CASCADE"), nullable=False, index=True)
    billable_metric_id = Column(UUIDType, ForeignKey("billable_metrics.id", ondelete="RESTRICT"), nullable=False, index=True)
